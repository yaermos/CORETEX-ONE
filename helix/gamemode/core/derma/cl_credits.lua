...
local CREDITS = {
	{"8301", "76561198440109059", {"Основатель проекта", "Разработчик"}},
	{"RefoselDev", "76561198393073512", {"Основатель проекта", "Главный разработчик"}},
	{"Vito Smertnik", "76561198998424013", {"Основатель проекта", "Главный Редактор"}},
	{"Den Kalosh", "76561198961134925", {"Технический Администратор"}},
	{"Bon", "76561199087363894", {"Консультант ALYX", "Спонсор проекта"}},
	{"Hershel", "76561199009805720", {"Главный Администратор"}},
    {"Pashok", "76561198253695220", {"Главный Архитектор"}},
	{"FьURY", "76561198988627797", {"Community Manager"}},
}

local SPECIALS = {
	{
		{"Demid", "76561198305728279"},
		{"Mk", "76561198016746572"}
	},
	{
		{"Santiago", "76561198736009363"}
	}
}

local MISC = {
	{"Coretex", "Настоящий символ Garry`s mod."},

}

local url = "https://vk.com/alyxroleplay"
local padding = 32
