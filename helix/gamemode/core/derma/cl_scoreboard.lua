...
function PANEL:Init()
	...
	self.icon.DoRightClick = function()
		...
		if client:IsAdmin() or client:IsSuperAdmin() then
			local adminmenu = menu:AddSubMenu("Административное Меню")
			adminmenu:AddOption( "goto", function() RunConsoleCommand("say", "!goto " .. client:SteamID() )end)
			adminmenu:AddOption( "return", function() RunConsoleCommand("say", "!return " .. client:SteamID() )end)
			adminmenu:AddOption( "bring", function() RunConsoleCommand("say", "!bring " .. client:SteamID() )end)
			adminmenu:AddOption( "god", function() RunConsoleCommand("say", "!god " .. client:SteamID() )end)
			adminmenu:AddOption( "ungod", function() RunConsoleCommand("say", "!ungod " .. client:SteamID() )end)
			adminmenu:AddOption( "noclip", function() RunConsoleCommand("say", "!noclip " .. client:SteamID() )end)
			adminmenu:AddOption( "hp", function() Derma_StringRequest( "Выдача здоровья!", "Сколько здоровье вы хотите выдать?", "100", function(a) RunConsoleCommand("say", "!hp " .. client:SteamID() .. " " .. a) end ) end)
			adminmenu:AddOption( "armor", function() Derma_StringRequest( "Выдача брони!", "Сколько брони вы хотите выдать?", "100", function(a) RunConsoleCommand("say", "!armor " .. client:SteamID() .. " " .. a) end ) end)

			local whitemenu = menu:AddSubMenu("Функциональное Меню")
			whitemenu:AddOption( "PlyTransfer", function() Derma_StringRequest( "PlyTransfer!", "PlyTransfer?", "", function(a) RunConsoleCommand("say", "/PlyTransfer " .. client:SteamID() .. " " .. a) end ) end)
			whitemenu:AddOption( "PlyUnwhitelist", function() Derma_StringRequest( "PlyUnwhitelist!", "PlyUnwhitelist?", "", function(a) RunConsoleCommand("say", "/PlyUnwhitelist " .. client:SteamID() .. " " .. a) end ) end)
			whitemenu:AddOption( "PlyWhitelist", function() Derma_StringRequest( "PlyWhitelist!", "PlyWhitelist?", "", function(a) RunConsoleCommand("say", "/PlyWhitelist " .. client:SteamID() .. " " .. a) end ) end)
		end
