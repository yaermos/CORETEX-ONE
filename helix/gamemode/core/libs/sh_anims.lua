...
ix.anim.SetModelClass("models/chr_hla_eli_default.mdl", "metrocop")
...
ix.anim.SetModelClass("models/hlvr/characters/combine/grunt/combine_beta_grunt_hlvr_player.mdl", "player")
ix.anim.SetModelClass("models/hlvr/characters/combine_captain/combine_captain_hlvr_player.mdl", "player")
ix.anim.SetModelClass("models/hlvr/characters/combine/grunt/combine_beta_grunt_hlvr_player.mdl", "player")
ix.anim.SetModelClass("models/player/combine_arctic.mdl", "player")
ix.anim.SetModelClass("models/cultist/hl_a/worker/hazmat_2/hazmat_2.mdl", "player")
ix.anim.SetModelClass("models/jq/hlvr/characters/olga/olga_rag.mdl", "citizen_female")
ix.anim.SetModelClass("models/hlvr/characters/russell/russell_player.mdl", "player")
ix.anim.SetModelClass("models/hlvr/characters/combine/suppressor/combine_suppressor_hlvr_player.mdl", "player")
ix.anim.SetModelClass("models/nasca/hl2/cmb/male_cp_penal1_pm.mdl", "player")
ix.anim.SetModelClass("models/nasca/hl2/cmb/male_cp_penal2_pm.mdl", "player")
ix.anim.SetModelClass("models/nasca/hl2/cmb/male_cp_penal3_pm.mdl", "player")
ix.anim.SetModelClass("models/nasca/hl2/cmb/male_cp_penal4_pm.mdl", "player")
ix.anim.SetModelClass("models/hlvr/characters/worker/worker_player.mdl", "player")
ix.anim.SetModelClass("models/lt_c/sci_fi/humans/male_09.mdl", "player")
ix.anim.SetModelClass("models/delta/destiny2/hunterexilemale.mdl", "player")
ix.anim.SetModelClass("models/destiny2/luxe_hunter/luxehunter.mdl", "player")
ix.anim.SetModelClass("models/kemono_friends/ezo_red_fox/ezo_red_fox_player.mdl", "player")
ix.anim.SetModelClass("models/kemono_friends/gray_wolf/gray_wolf_player.mdl", "player")
ix.anim.SetModelClass("models/kemono_friends/silver_fox/silver_fox_player.mdl", "player")
ix.anim.SetModelClass("models/pacagma/kemono_friends/red_fox/red_fox_player.mdl", "player")
ix.anim.SetModelClass("models/Lenoax/gordonfreeman_pm.mdl", "player")
ix.anim.SetModelClass("models/Lenoax/markiv_pm.mdl", "player")
ix.anim.SetModelClass("models/stalker_player/stalker_player.mdl", "player")
ix.anim.SetModelClass("models/lt_c/sci_fi/humans/male_08.mdl", "player")
