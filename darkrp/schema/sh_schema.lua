...
Schema.name = "λ CORETΞX HL:ALYX λ"
Schema.author = "nebulous.cloud & Coretex"
Schema.description = "▶ Проект по вселенной HL:ALYX на MediumRP формате."
...
do
	...
	CLASS.format = "Объявление Центра \"%s\""
